...
describe('Zustand Store', () => {
	beforeEach(() => {
		store.setState(initialState); // Isso vai garantir que a cada teste o zustand vai substituir o estado para o original que a aplicação começou para resetar tudo.
	});
	...
	it('Should be able to auto play the next video', () => {
